...
/////////////////////////////////////////////////////
	TIM_TimeBaseStructInit(&TIM_TimeBaseStructure);
  	...
  	TIM_TimeBaseStructure.TIM_Period = 20000; //设定计数器自动重装值
...
uint16_t Motor_GetStep(uint8_t index);
{
	...
	switch(idex)
        {
        case 1:  Encoder_TIM= (short)TIM2 -> CNT; ;break;
        case 2:  Encoder_TIM= (short)TIM3 -> CNT; ;break;        
        case 3:  Encoder_TIM= (short)TIM4 -> CNT; ;break;        
        case 4:  Encoder_TIM= (short)TIM5 -> CNT; ;break;        
